      ...
      <section className="py-20 px-6">
        ...
        >
          ...
          <div className="space-y-8 text-lg leading-relaxed">
            <p>
              এই Terms and Conditions (“Terms”) আপনার এবং বাইটক্যাম্প (“we”, “our”, “us”) এর মধ্যে চুক্তি হিসেবে গণ্য হবে।
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>বাইটক্যাম্প-এর সাথে সংযুক্ত কোনো ভিডিও, কনটেন্ট বা পাসওয়ার্ড শেয়ার করা আইনত অপরাধ।</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>আমাদের সমস্ত কনটেন্ট, ভিডিও, নোট এবং ডিজাইন বাইটক্যাম্প-এর সম্পত্তি।</li>
            ...
            <div>
              ...
              <ul className="list-decimal list-inside space-y-1">
                ...
                <li>অন্য শিক্ষার্থী বা বাইটক্যাম্প-এর সিস্টেমকে ক্ষতিগ্রস্ত করা।</li>
              </ul>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>
                  বাইটক্যাম্প কোর্স বা ওয়েবসাইট ব্যবহার করার কারণে কোনো প্রকার সরাসরি বা পরোক্ষ ক্ষতির জন্য দায়ী থাকবে না।
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                বাইটক্যাম্প যেকোনো সময়ে ব্যবহারকারীর অ্যাকাউন্ট বন্ধ করতে পারে যদি Terms লঙ্ঘন করা হয়।
              </p>
            </div>
